...
class DeviceCapabilityDetector @Inject constructor(
     ...
     */
    private fun classifyTier(totalRamMB: Int, cpuCores: Int, apiLevel: Int): DeviceTier {
    ...
    fun getRecommendedConfig(): RecommendedConfig {
        ...
        return when (capabilities.tier) {
            DeviceTier.FLAGSHIP -> RecommendedConfig(
                useCloudSTT = true,
                useCloudTTS = true,
                useCloudLLM = true,
            ...
            DeviceTier.STANDARD -> RecommendedConfig(
                useCloudSTT = true,
                useCloudTTS = true,
                useCloudLLM = true,
            ...
            DeviceTier.MINIMUM -> RecommendedConfig(
