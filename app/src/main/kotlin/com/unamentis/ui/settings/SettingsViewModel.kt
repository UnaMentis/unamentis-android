...
class SettingsViewModel @Inject constructor(
     ...
     */
    val currentPreset: StateFlow<ConfigurationPreset> = providerConfig.configurationPreset
        .stateIn(
     ...
     * Selected providers.
     */
    val selectedSTTProvider: StateFlow<String> = providerConfig.selectedSTTProvider
        .stateIn(
            scope = viewModelScope,
            started = SharingStarted.WhileSubscribed(5000),
     ...
     * Cost preference.
     */
    val costPreference: StateFlow<String> = providerConfig.costPreference
        .stateIn(
            scope = viewModelScope,
            started = SharingStarted.WhileSubscribed(5000),
