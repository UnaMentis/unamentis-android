...
class HistoryViewModel @Inject constructor(
     ...
     */
    private val sessions: StateFlow<List<Session>> = sessionRepository
        .getAllSessions()
        .stateIn(
     ...
     */
    fun exportAsJson(session: Session, transcript: List<TranscriptEntry>): String {
        return buildString {
            appendLine("{")
     ...
     */
    fun exportAsText(session: Session, transcript: List<TranscriptEntry>): String {
        return buildString {
            ...
            appendLine("Start Time: ${java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss", java.util.Locale.getDefault()).format(java.util.Date(session.startTime))}")
            session.endTime?.let {
